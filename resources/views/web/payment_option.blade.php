                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row ">
                            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                                <input type="submit" class="btn btn-danger" onClick='history.go(-1);' value="CANCEL" />
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                                <input type="submit" class="btn btn-warning btn-block" onClick='history.go(-1);' value="PAY NOW" />
                            </div>
                        </div>
